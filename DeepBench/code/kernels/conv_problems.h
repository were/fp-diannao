...
std::vector<std::tuple<unsigned int, unsigned int, unsigned int, unsigned int,
    ...
    std::make_tuple(224, 224, 64, 1, 64, 3, 3, 2, 2, 1, 1),
    std::make_tuple(224, 224, 64, 2, 64, 3, 3, 2, 2, 1, 1),
    std::make_tuple(224, 224, 64, 4, 64, 3, 3, 2, 2, 1, 1),
    std::make_tuple(224, 224, 64, 8, 64, 3, 3, 2, 2, 1, 1),
    std::make_tuple(224, 224, 64, 16, 64, 3, 3, 2, 2, 1, 1),
    std::make_tuple(14, 14, 512, 1, 512, 3, 3, 2, 2, 1, 1),
    std::make_tuple(14, 14, 512, 2, 512, 3, 3, 2, 2, 1, 1),
    std::make_tuple(14, 14, 512, 4, 512, 3, 3, 2, 2, 1, 1),
    std::make_tuple(14, 14, 512, 8, 512, 3, 3, 2, 2, 1, 1),
    std::make_tuple(14, 14, 512, 16, 512, 3, 3, 2, 2, 1, 1),
    std::make_tuple(14, 14, 512, 256, 512, 3, 3, 2, 2, 1, 1)
};
...
std::vector<std::tuple<unsigned int, unsigned int, unsigned int, unsigned int,
    ...
    //std::make_tuple(14, 14, 1024, 1, 2048, 1, 1, 0, 0, 2, 2),
    //std::make_tuple(7, 7, 2048, 1, 512, 1, 1, 0, 0, 1, 1),
    std::make_tuple(14, 14, 512, 512, 512, 1, 1, 3, 3, 1, 1),
    std::make_tuple(224, 224, 64, 64, 64, 1, 1, 3, 3, 1, 1)
};
